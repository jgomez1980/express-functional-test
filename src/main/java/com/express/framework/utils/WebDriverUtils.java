package com.express.framework.utils;
...
import com.express.framework.tdm.EnvironmentProvider;
...
public class WebDriverUtils {
    ...
    public static void initializePageInstance(WebDriver driver)
            throws EncryptedDocumentException, InvalidFormatException, IOException {
    	driver.get(EnvironmentProvider.getUrl(getEnvironment()));
        System.out.println("---");
        System.out.println("ENVIRONMENT: " + EnvironmentProvider.getUrl(getEnvironment()));
    }   
